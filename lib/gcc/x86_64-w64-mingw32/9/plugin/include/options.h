...
enum opt_code
{
  ...
  OPT_mcx16 = 1333,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1334,            /* -mdispatch-scheduler */
  OPT_mdll = 1335,                           /* -mdll */
  OPT_mdump_tune_features = 1336,            /* -mdump-tune-features */
  OPT_mf16c = 1337,                          /* -mf16c */
  OPT_mfancy_math_387 = 1338,                /* -mfancy-math-387 */
  OPT_mfentry = 1339,                        /* -mfentry */
  OPT_mfentry_name_ = 1340,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1341,               /* -mfentry-section= */
  OPT_mfma = 1342,                           /* -mfma */
  OPT_mfma4 = 1343,                          /* -mfma4 */
  OPT_mforce_drap = 1344,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1345,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1346,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1347,                       /* -mfpmath= */
  OPT_mfsgsbase = 1348,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1349,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1350, */              /* -mfused-madd */
  OPT_mfxsr = 1351,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1352,             /* -mgeneral-regs-only */
  OPT_mgfni = 1353,                          /* -mgfni */
  OPT_mhard_float = 1354,                    /* -mhard-float */
  OPT_mhle = 1355,                           /* -mhle */
  OPT_miamcu = 1356,                         /* -miamcu */
  OPT_mieee_fp = 1357,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1358,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_register = 1359,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1360,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1361,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1362,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1363,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1364, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1365,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1366,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1367,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1368,                /* -mlong-double-80 */
  OPT_mlwp = 1369,                           /* -mlwp */
  OPT_mlzcnt = 1370,                         /* -mlzcnt */
  OPT_mmanual_endbr = 1371,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 1372,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1373,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1374,                  /* -mmitigate-rop */
  OPT_mmmx = 1375,                           /* -mmmx */
  OPT_mmovbe = 1376,                         /* -mmovbe */
  OPT_mmovdir64b = 1377,                     /* -mmovdir64b */
  OPT_mmovdiri = 1378,                       /* -mmovdiri */
  OPT_mmpx = 1379,                           /* -mmpx */
  OPT_mms_bitfields = 1380,                  /* -mms-bitfields */
  ...
  OPT_mnop_fun_dllimport = 1388,             /* -mnop-fun-dllimport */
  OPT_mnop_mcount = 1389,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1390,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1391,                          /* -mpc32 */
  OPT_mpc64 = 1392,                          /* -mpc64 */
  OPT_mpc80 = 1393,                          /* -mpc80 */
  OPT_mpclmul = 1394,                        /* -mpclmul */
  OPT_mpcommit = 1395,                       /* -mpcommit */
  OPT_mpconfig = 1396,                       /* -mpconfig */
  OPT_mpe_aligned_commons = 1397,            /* -mpe-aligned-commons */
  OPT_mpku = 1398,                           /* -mpku */
  OPT_mpopcnt = 1399,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1400, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1401,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1402,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1403,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1404,                        /* -mprfchw */
  OPT_mptwrite = 1405,                       /* -mptwrite */
  OPT_mpush_args = 1406,                     /* -mpush-args */
  OPT_mrdpid = 1407,                         /* -mrdpid */
  OPT_mrdrnd = 1408,                         /* -mrdrnd */
  OPT_mrdseed = 1409,                        /* -mrdseed */
  OPT_mrecip = 1410,                         /* -mrecip */
  OPT_mrecip_ = 1411,                        /* -mrecip= */
  OPT_mrecord_mcount = 1412,                 /* -mrecord-mcount */
  OPT_mrecord_return = 1413,                 /* -mrecord-return */
  OPT_mred_zone = 1414,                      /* -mred-zone */
  OPT_mregparm_ = 1415,                      /* -mregparm= */
  OPT_mrtd = 1416,                           /* -mrtd */
  OPT_mrtm = 1417,                           /* -mrtm */
  OPT_msahf = 1418,                          /* -msahf */
  OPT_msgx = 1419,                           /* -msgx */
  OPT_msha = 1420,                           /* -msha */
  OPT_mshstk = 1421,                         /* -mshstk */
  OPT_mskip_rax_setup = 1422,                /* -mskip-rax-setup */
  OPT_msoft_float = 1423,                    /* -msoft-float */
  OPT_msse = 1424,                           /* -msse */
  OPT_msse2 = 1425,                          /* -msse2 */
  OPT_msse2avx = 1426,                       /* -msse2avx */
  OPT_msse3 = 1427,                          /* -msse3 */
  OPT_msse4 = 1428,                          /* -msse4 */
  OPT_msse4_1 = 1429,                        /* -msse4.1 */
  OPT_msse4_2 = 1430,                        /* -msse4.2 */
  OPT_msse4a = 1431,                         /* -msse4a */
  /* OPT_msse5 = 1432, */                    /* -msse5 */
  OPT_msseregparm = 1433,                    /* -msseregparm */
  OPT_mssse3 = 1434,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1435,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 1436, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1437,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 1438, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1439,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1440,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1441,            /* -mstringop-strategy= */
  OPT_mstv = 1442,                           /* -mstv */
  OPT_mtbm = 1443,                           /* -mtbm */
  OPT_mthreads = 1444,                       /* -mthreads */
  OPT_mtls_dialect_ = 1445,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1446,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1447,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1448,                         /* -mtune= */
  OPT_municode = 1449,                       /* -municode */
  OPT_muse_libstdc_wrappers = 1450,          /* -muse-libstdc-wrappers */
  OPT_mvaes = 1451,                          /* -mvaes */
  OPT_mveclibabi_ = 1452,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1453,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1454,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1455,                    /* -mvzeroupper */
  OPT_mwaitpkg = 1456,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 1457,                      /* -mwbnoinvd */
  OPT_mwin32 = 1458,                         /* -mwin32 */
  OPT_mwindows = 1459,                       /* -mwindows */
  OPT_mx32 = 1460,                           /* -mx32 */
  OPT_mxop = 1461,                           /* -mxop */
  OPT_mxsave = 1462,                         /* -mxsave */
  OPT_mxsavec = 1463,                        /* -mxsavec */
  OPT_mxsaveopt = 1464,                      /* -mxsaveopt */
  OPT_mxsaves = 1465,                        /* -mxsaves */
  OPT_n = 1466,                              /* -n */
  OPT_no_canonical_prefixes = 1467,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1468,              /* -no-integrated-cpp */
  OPT_no_pie = 1469,                         /* -no-pie */
  OPT_no_pthread = 1470,                     /* -no-pthread */
  OPT_nocpp = 1471,                          /* -nocpp */
  OPT_nodefaultlibs = 1472,                  /* -nodefaultlibs */
  OPT_nolibc = 1473,                         /* -nolibc */
  OPT_nophoboslib = 1474,                    /* -nophoboslib */
  OPT_nostartfiles = 1475,                   /* -nostartfiles */
  OPT_nostdinc = 1476,                       /* -nostdinc */
  OPT_nostdinc__ = 1477,                     /* -nostdinc++ */
  OPT_nostdlib = 1478,                       /* -nostdlib */
  OPT_o = 1479,                              /* -o */
  OPT_p = 1480,                              /* -p */
  OPT_pass_exit_codes = 1481,                /* -pass-exit-codes */
  /* OPT_pedantic = 1482, */                 /* -pedantic */
  OPT_pedantic_errors = 1483,                /* -pedantic-errors */
  OPT_pg = 1484,                             /* -pg */
  OPT_pie = 1485,                            /* -pie */
  OPT_pipe = 1486,                           /* -pipe */
  OPT_posix = 1487,                          /* -posix */
  OPT_print_file_name_ = 1488,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1489,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1490,          /* -print-multi-directory */
  OPT_print_multi_lib = 1491,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1492,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1493,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1494,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1495,               /* -print-prog-name= */
  OPT_print_search_dirs = 1496,              /* -print-search-dirs */
  OPT_print_sysroot = 1497,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1498,   /* -print-sysroot-headers-suffix */
  OPT_pthread = 1499,                        /* -pthread */
  OPT_quiet = 1500,                          /* -quiet */
  OPT_r = 1501,                              /* -r */
  OPT_remap = 1502,                          /* -remap */
  OPT_s = 1503,                              /* -s */
  OPT_save_temps = 1504,                     /* -save-temps */
  OPT_save_temps_ = 1505,                    /* -save-temps= */
  OPT_shared = 1506,                         /* -shared */
  OPT_shared_libgcc = 1507,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1508,               /* -shared-libphobos */
  /* OPT_specs = 1509, */                    /* -specs */
  OPT_specs_ = 1510,                         /* -specs= */
  OPT_static = 1511,                         /* -static */
  OPT_static_libasan = 1512,                 /* -static-libasan */
  OPT_static_libgcc = 1513,                  /* -static-libgcc */
  OPT_static_libgfortran = 1514,             /* -static-libgfortran */
  OPT_static_libgo = 1515,                   /* -static-libgo */
  OPT_static_liblsan = 1516,                 /* -static-liblsan */
  OPT_static_libmpx = 1517,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1518,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1519,               /* -static-libphobos */
  OPT_static_libstdc__ = 1520,               /* -static-libstdc++ */
  OPT_static_libtsan = 1521,                 /* -static-libtsan */
  OPT_static_libubsan = 1522,                /* -static-libubsan */
  OPT_static_pie = 1523,                     /* -static-pie */
  /* OPT_std_c__03 = 1524, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1525, */                /* -std=c++0x */
  OPT_std_c__11 = 1526,                      /* -std=c++11 */
  OPT_std_c__14 = 1527,                      /* -std=c++14 */
  OPT_std_c__17 = 1528,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1529, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1530, */                /* -std=c++1z */
  OPT_std_c__2a = 1531,                      /* -std=c++2a */
  OPT_std_c__98 = 1532,                      /* -std=c++98 */
  OPT_std_c11 = 1533,                        /* -std=c11 */
  OPT_std_c17 = 1534,                        /* -std=c17 */
  /* OPT_std_c18 = 1535, */                  /* -std=c18 */
  /* OPT_std_c1x = 1536, */                  /* -std=c1x */
  OPT_std_c2x = 1537,                        /* -std=c2x */
  /* OPT_std_c89 = 1538, */                  /* -std=c89 */
  OPT_std_c90 = 1539,                        /* -std=c90 */
  OPT_std_c99 = 1540,                        /* -std=c99 */
  /* OPT_std_c9x = 1541, */                  /* -std=c9x */
  OPT_std_f2003 = 1542,                      /* -std=f2003 */
  OPT_std_f2008 = 1543,                      /* -std=f2008 */
  OPT_std_f2008ts = 1544,                    /* -std=f2008ts */
  OPT_std_f2018 = 1545,                      /* -std=f2018 */
  OPT_std_f95 = 1546,                        /* -std=f95 */
  OPT_std_gnu = 1547,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1548, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1549, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1550,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1551,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1552,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1553, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1554, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1555,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1556,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1557,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1558,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1559, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1560, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1561,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1562, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1563,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1564,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1565, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1566, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1567,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1568, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1569, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1570, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1571, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1572, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1573,                     /* -std=legacy */
  OPT_symbolic = 1574,                       /* -symbolic */
  OPT_t = 1575,                              /* -t */
  OPT_time = 1576,                           /* -time */
  OPT_time_ = 1577,                          /* -time= */
  OPT_traditional = 1578,                    /* -traditional */
  OPT_traditional_cpp = 1579,                /* -traditional-cpp */
  OPT_trigraphs = 1580,                      /* -trigraphs */
  OPT_u = 1581,                              /* -u */
  OPT_undef = 1582,                          /* -undef */
  OPT_v = 1583,                              /* -v */
  OPT_version = 1584,                        /* -version */
  OPT_w = 1585,                              /* -w */
  OPT_wrapper = 1586,                        /* -wrapper */
  OPT_x = 1587,                              /* -x */
  OPT_z = 1588,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
