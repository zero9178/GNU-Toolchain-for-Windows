...
enum opt_code
{
  ...
  OPT_msgx = 1744,                           /* -msgx */
  OPT_msha = 1745,                           /* -msha */
  OPT_mshstk = 1746,                         /* -mshstk */
  OPT_mskip_rax_setup = 1747,                /* -mskip-rax-setup */
  OPT_msoft_float = 1748,                    /* -msoft-float */
  OPT_msse = 1749,                           /* -msse */
  OPT_msse2 = 1750,                          /* -msse2 */
  OPT_msse2avx = 1751,                       /* -msse2avx */
  OPT_msse3 = 1752,                          /* -msse3 */
  OPT_msse4 = 1753,                          /* -msse4 */
  OPT_msse4_1 = 1754,                        /* -msse4.1 */
  OPT_msse4_2 = 1755,                        /* -msse4.2 */
  OPT_msse4a = 1756,                         /* -msse4a */
  /* OPT_msse5 = 1757, */                    /* -msse5 */
  OPT_msseregparm = 1758,                    /* -msseregparm */
  OPT_mssse3 = 1759,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1760,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 1761, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1762,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 1763, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1764,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1765,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1766,            /* -mstringop-strategy= */
  OPT_mstv = 1767,                           /* -mstv */
  OPT_mtbm = 1768,                           /* -mtbm */
  OPT_mthreads = 1769,                       /* -mthreads */
  ...
  OPT_municode = 1774,                       /* -municode */
  OPT_muse_libstdc_wrappers = 1775,          /* -muse-libstdc-wrappers */
  OPT_mvaes = 1776,                          /* -mvaes */
  OPT_mveclibabi_ = 1777,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1778,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1779,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1780,                    /* -mvzeroupper */
  OPT_mwaitpkg = 1781,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 1782,                      /* -mwbnoinvd */
  OPT_mwin32 = 1783,                         /* -mwin32 */
  OPT_mwindows = 1784,                       /* -mwindows */
  OPT_mx32 = 1785,                           /* -mx32 */
  OPT_mxop = 1786,                           /* -mxop */
  OPT_mxsave = 1787,                         /* -mxsave */
  OPT_mxsavec = 1788,                        /* -mxsavec */
  OPT_mxsaveopt = 1789,                      /* -mxsaveopt */
  OPT_mxsaves = 1790,                        /* -mxsaves */
  OPT_n = 1791,                              /* -n */
  OPT_name_sort = 1792,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1793,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1794,              /* -no-integrated-cpp */
  OPT_no_pie = 1795,                         /* -no-pie */
  OPT_no_pthread = 1796,                     /* -no-pthread */
  ...
  OPT_pthread = 1827,                        /* -pthread */
  OPT_quiet = 1828,                          /* -quiet */
  OPT_r = 1829,                              /* -r */
  OPT_remap = 1830,                          /* -remap */
  OPT_reverse_sort = 1831,                   /* -reverse-sort */
  OPT_s = 1832,                              /* -s */
  OPT_save_temps = 1833,                     /* -save-temps */
  OPT_save_temps_ = 1834,                    /* -save-temps= */
  OPT_shared = 1835,                         /* -shared */
  OPT_shared_libgcc = 1836,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1837,               /* -shared-libphobos */
  OPT_size_sort = 1838,                      /* -size-sort */
  /* OPT_specs = 1839, */                    /* -specs */
  OPT_specs_ = 1840,                         /* -specs= */
  OPT_static = 1841,                         /* -static */
  OPT_static_libasan = 1842,                 /* -static-libasan */
  OPT_static_libgcc = 1843,                  /* -static-libgcc */
  OPT_static_libgfortran = 1844,             /* -static-libgfortran */
  OPT_static_libgo = 1845,                   /* -static-libgo */
  OPT_static_liblsan = 1846,                 /* -static-liblsan */
  OPT_static_libmpx = 1847,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1848,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1849,               /* -static-libphobos */
  OPT_static_libstdc__ = 1850,               /* -static-libstdc++ */
  OPT_static_libtsan = 1851,                 /* -static-libtsan */
  OPT_static_libubsan = 1852,                /* -static-libubsan */
  OPT_static_pie = 1853,                     /* -static-pie */
  /* OPT_std_c__03 = 1854, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1855, */                /* -std=c++0x */
  OPT_std_c__11 = 1856,                      /* -std=c++11 */
  OPT_std_c__14 = 1857,                      /* -std=c++14 */
  OPT_std_c__17 = 1858,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1859, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1860, */                /* -std=c++1z */
  /* OPT_std_c__20 = 1861, */                /* -std=c++20 */
  OPT_std_c__2a = 1862,                      /* -std=c++2a */
  OPT_std_c__98 = 1863,                      /* -std=c++98 */
  OPT_std_c11 = 1864,                        /* -std=c11 */
  OPT_std_c17 = 1865,                        /* -std=c17 */
  /* OPT_std_c18 = 1866, */                  /* -std=c18 */
  /* OPT_std_c1x = 1867, */                  /* -std=c1x */
  OPT_std_c2x = 1868,                        /* -std=c2x */
  /* OPT_std_c89 = 1869, */                  /* -std=c89 */
  OPT_std_c90 = 1870,                        /* -std=c90 */
  OPT_std_c99 = 1871,                        /* -std=c99 */
  /* OPT_std_c9x = 1872, */                  /* -std=c9x */
  OPT_std_f2003 = 1873,                      /* -std=f2003 */
  OPT_std_f2008 = 1874,                      /* -std=f2008 */
  OPT_std_f2008ts = 1875,                    /* -std=f2008ts */
  OPT_std_f2018 = 1876,                      /* -std=f2018 */
  OPT_std_f95 = 1877,                        /* -std=f95 */
  OPT_std_gnu = 1878,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1879, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1880, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1881,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1882,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1883,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1884, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1885, */              /* -std=gnu++1z */
  /* OPT_std_gnu__20 = 1886, */              /* -std=gnu++20 */
