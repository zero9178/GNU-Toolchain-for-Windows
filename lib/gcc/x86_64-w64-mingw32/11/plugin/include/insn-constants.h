...
enum unspec {
  ...
  UNSPEC_VPSHRDV = 197,
  UNSPEC_VPSHLDV = 198,
  UNSPEC_VPMADDUBSWACCD = 199,
  UNSPEC_VPMADDUBSWACCSSD = 200,
  UNSPEC_VPMADDWDACCD = 201,
  UNSPEC_VPMADDWDACCSSD = 202,
  UNSPEC_VAESDEC = 203,
  ...
  UNSPEC_VCVTNE2PS2BF16 = 210,
  UNSPEC_VCVTNEPS2BF16 = 211,
  UNSPEC_VDPBF16PS = 212,
  UNSPEC_LFENCE = 213,
  UNSPEC_SFENCE = 214,
  UNSPEC_MFENCE = 215,
  UNSPEC_FILD_ATOMIC = 216,
  UNSPEC_FIST_ATOMIC = 217,
  UNSPEC_LDX_ATOMIC = 218,
  UNSPEC_STX_ATOMIC = 219,
  UNSPEC_LDA = 220,
  UNSPEC_STA = 221
};
...
enum unspecv {
  ...
  UNSPECV_ENQCMD = 75,
  UNSPECV_ENQCMDS = 76,
  UNSPECV_SERIALIZE = 77,
  UNSPECV_PATCHABLE_AREA = 78,
  UNSPECV_EMMS = 79,
  UNSPECV_FEMMS = 80,
  UNSPECV_LDMXCSR = 81,
  UNSPECV_STMXCSR = 82,
