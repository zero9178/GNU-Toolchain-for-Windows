...
enum opt_code
{
  ...
  OPT_fset_stack_executable = 1366,          /* -fset-stack-executable */
  ...
  OPT_fwritable_relocated_rdata = 1542,      /* -fwritable-relocated-rdata */
  ...
  OPT_list = 1601,                           /* -list */
  OPT_m128bit_long_double = 1602,            /* -m128bit-long-double */
  OPT_m16 = 1603,                            /* -m16 */
  OPT_m32 = 1604,                            /* -m32 */
  OPT_m3dnow = 1605,                         /* -m3dnow */
  OPT_m3dnowa = 1606,                        /* -m3dnowa */
  OPT_m64 = 1607,                            /* -m64 */
  OPT_m80387 = 1608,                         /* -m80387 */
  OPT_m8bit_idiv = 1609,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1610,             /* -m96bit-long-double */
  OPT_mabi_ = 1611,                          /* -mabi= */
  OPT_mabm = 1612,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1613,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1614,                 /* -maddress-mode= */
  OPT_madx = 1615,                           /* -madx */
  OPT_maes = 1616,                           /* -maes */
  OPT_malign_data_ = 1617,                   /* -malign-data= */
  OPT_malign_double = 1618,                  /* -malign-double */
  OPT_malign_functions_ = 1619,              /* -malign-functions= */
  OPT_malign_jumps_ = 1620,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1621,                  /* -malign-loops= */
  OPT_malign_stringops = 1622,               /* -malign-stringops */
  OPT_march_ = 1623,                         /* -march= */
  OPT_masm_ = 1624,                          /* -masm= */
  OPT_mavx = 1625,                           /* -mavx */
  OPT_mavx2 = 1626,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1627,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1628,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1629,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1630,                  /* -mavx5124vnniw */
  OPT_mavx512bf16 = 1631,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 1632,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1633,                      /* -mavx512bw */
  OPT_mavx512cd = 1634,                      /* -mavx512cd */
  OPT_mavx512dq = 1635,                      /* -mavx512dq */
  OPT_mavx512er = 1636,                      /* -mavx512er */
  OPT_mavx512f = 1637,                       /* -mavx512f */
  OPT_mavx512ifma = 1638,                    /* -mavx512ifma */
  OPT_mavx512pf = 1639,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1640,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1641,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1642,                      /* -mavx512vl */
  OPT_mavx512vnni = 1643,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 1644,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 1645,               /* -mavx512vpopcntdq */
  OPT_mbmi = 1646,                           /* -mbmi */
  ...
  OPT_mconsole = 1657,                       /* -mconsole */
  /* OPT_mcpu_ = 1658, */                    /* -mcpu= */
  OPT_mcrc32 = 1659,                         /* -mcrc32 */
  OPT_mcx16 = 1660,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1661,            /* -mdispatch-scheduler */
  OPT_mdll = 1662,                           /* -mdll */
  OPT_mdump_tune_features = 1663,            /* -mdump-tune-features */
  OPT_menqcmd = 1664,                        /* -menqcmd */
  OPT_mf16c = 1665,                          /* -mf16c */
  OPT_mfancy_math_387 = 1666,                /* -mfancy-math-387 */
  OPT_mfentry = 1667,                        /* -mfentry */
  OPT_mfentry_name_ = 1668,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1669,               /* -mfentry-section= */
  OPT_mfma = 1670,                           /* -mfma */
  OPT_mfma4 = 1671,                          /* -mfma4 */
  OPT_mforce_drap = 1672,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1673,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1674,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1675,                       /* -mfpmath= */
  OPT_mfsgsbase = 1676,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1677,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1678, */              /* -mfused-madd */
  OPT_mfxsr = 1679,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1680,             /* -mgeneral-regs-only */
  OPT_mgfni = 1681,                          /* -mgfni */
  OPT_mhard_float = 1682,                    /* -mhard-float */
  OPT_mhle = 1683,                           /* -mhle */
  OPT_miamcu = 1684,                         /* -miamcu */
  OPT_mieee_fp = 1685,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1686,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_register = 1687,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1688,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1689,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1690,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1691,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1692, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1693,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1694,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1695,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1696,                /* -mlong-double-80 */
  OPT_mlwp = 1697,                           /* -mlwp */
  OPT_mlzcnt = 1698,                         /* -mlzcnt */
  OPT_mmanual_endbr = 1699,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 1700,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1701,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1702,                  /* -mmitigate-rop */
  OPT_mmmx = 1703,                           /* -mmmx */
  OPT_mmovbe = 1704,                         /* -mmovbe */
  OPT_mmovdir64b = 1705,                     /* -mmovdir64b */
  OPT_mmovdiri = 1706,                       /* -mmovdiri */
  OPT_mmpx = 1707,                           /* -mmpx */
  OPT_mms_bitfields = 1708,                  /* -mms-bitfields */
  ...
  OPT_mnop_fun_dllimport = 1716,             /* -mnop-fun-dllimport */
  OPT_mnop_mcount = 1717,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1718,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1719,                          /* -mpc32 */
  OPT_mpc64 = 1720,                          /* -mpc64 */
  OPT_mpc80 = 1721,                          /* -mpc80 */
  OPT_mpclmul = 1722,                        /* -mpclmul */
  OPT_mpcommit = 1723,                       /* -mpcommit */
  OPT_mpconfig = 1724,                       /* -mpconfig */
  OPT_mpe_aligned_commons = 1725,            /* -mpe-aligned-commons */
  OPT_mpku = 1726,                           /* -mpku */
  OPT_mpopcnt = 1727,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1728, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1729,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1730,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1731,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1732,                        /* -mprfchw */
  OPT_mptwrite = 1733,                       /* -mptwrite */
  OPT_mpush_args = 1734,                     /* -mpush-args */
  OPT_mrdpid = 1735,                         /* -mrdpid */
  OPT_mrdrnd = 1736,                         /* -mrdrnd */
  OPT_mrdseed = 1737,                        /* -mrdseed */
  OPT_mrecip = 1738,                         /* -mrecip */
  OPT_mrecip_ = 1739,                        /* -mrecip= */
  OPT_mrecord_mcount = 1740,                 /* -mrecord-mcount */
  OPT_mrecord_return = 1741,                 /* -mrecord-return */
  OPT_mred_zone = 1742,                      /* -mred-zone */
  OPT_mregparm_ = 1743,                      /* -mregparm= */
  OPT_mrtd = 1744,                           /* -mrtd */
  OPT_mrtm = 1745,                           /* -mrtm */
  OPT_msahf = 1746,                          /* -msahf */
  OPT_mserialize = 1747,                     /* -mserialize */
  OPT_msgx = 1748,                           /* -msgx */
  OPT_msha = 1749,                           /* -msha */
  OPT_mshstk = 1750,                         /* -mshstk */
  OPT_mskip_rax_setup = 1751,                /* -mskip-rax-setup */
  OPT_msoft_float = 1752,                    /* -msoft-float */
  OPT_msse = 1753,                           /* -msse */
  OPT_msse2 = 1754,                          /* -msse2 */
  OPT_msse2avx = 1755,                       /* -msse2avx */
  OPT_msse3 = 1756,                          /* -msse3 */
  OPT_msse4 = 1757,                          /* -msse4 */
  OPT_msse4_1 = 1758,                        /* -msse4.1 */
  OPT_msse4_2 = 1759,                        /* -msse4.2 */
  OPT_msse4a = 1760,                         /* -msse4a */
  /* OPT_msse5 = 1761, */                    /* -msse5 */
  OPT_msseregparm = 1762,                    /* -msseregparm */
  OPT_mssse3 = 1763,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1764,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 1765, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1766,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 1767, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1768,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1769,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1770,            /* -mstringop-strategy= */
  OPT_mstv = 1771,                           /* -mstv */
  OPT_mtbm = 1772,                           /* -mtbm */
  OPT_mthreads = 1773,                       /* -mthreads */
  OPT_mtls_dialect_ = 1774,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1775,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 1776,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 1777,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1778,                         /* -mtune= */
  OPT_municode = 1779,                       /* -municode */
  OPT_muse_libstdc_wrappers = 1780,          /* -muse-libstdc-wrappers */
  OPT_mvaes = 1781,                          /* -mvaes */
  OPT_mveclibabi_ = 1782,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1783,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1784,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1785,                    /* -mvzeroupper */
  OPT_mwaitpkg = 1786,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 1787,                      /* -mwbnoinvd */
  OPT_mwin32 = 1788,                         /* -mwin32 */
  OPT_mwindows = 1789,                       /* -mwindows */
  OPT_mx32 = 1790,                           /* -mx32 */
  OPT_mxop = 1791,                           /* -mxop */
  OPT_mxsave = 1792,                         /* -mxsave */
  OPT_mxsavec = 1793,                        /* -mxsavec */
  OPT_mxsaveopt = 1794,                      /* -mxsaveopt */
  OPT_mxsaves = 1795,                        /* -mxsaves */
  OPT_n = 1796,                              /* -n */
  ...
  OPT_no_pthread = 1801,                     /* -no-pthread */
  ...
  OPT_std_gnu__98 = 1893,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1894,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1895,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1896, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1897, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1898,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1899, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1900,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1901,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1902, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1903, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1904,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1905, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1906, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1907, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1908, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1909, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1910,                     /* -std=legacy */
  OPT_symbol_ = 1911,                        /* -symbol= */
  OPT_symbolic = 1912,                       /* -symbolic */
  OPT_t = 1913,                              /* -t */
  OPT_time = 1914,                           /* -time */
  OPT_time_ = 1915,                          /* -time= */
  OPT_traditional = 1916,                    /* -traditional */
  OPT_traditional_cpp = 1917,                /* -traditional-cpp */
  OPT_tree_stats = 1918,                     /* -tree-stats */
  OPT_trigraphs = 1919,                      /* -trigraphs */
  OPT_type_stats = 1920,                     /* -type-stats */
  OPT_u = 1921,                              /* -u */
  OPT_undef = 1922,                          /* -undef */
  OPT_v = 1923,                              /* -v */
  OPT_version = 1924,                        /* -version */
  OPT_w = 1925,                              /* -w */
  OPT_wrapper = 1926,                        /* -wrapper */
  OPT_x = 1927,                              /* -x */
  OPT_z = 1928,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
